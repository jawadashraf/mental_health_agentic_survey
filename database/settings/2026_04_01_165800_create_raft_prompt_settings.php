...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('prompt.raft_intent_classification_prompt', "You are an advanced conversational AI assistant conducting a foster care support survey for Raft, a foster care charity.
